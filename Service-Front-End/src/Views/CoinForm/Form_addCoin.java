...
public class Form_addCoin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cadastar Tipos de Moedas");
        ...
        txt_sigla.setBackground(new java.awt.Color(32, 32, 36));
        txt_sigla.setFont(new java.awt.Font("Yu Gothic", 1, 14)); // NOI18N
        txt_sigla.setForeground(new java.awt.Color(255, 255, 255));
        txt_sigla.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(32, 32, 36)));
        txt_sigla.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                txt_siglaMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txt_sigla, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 440, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(9, 9, 9)
                .addComponent(txt_sigla, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(108, 108, 108)
    ...
    private void txt_siglaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txt_siglaMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_siglaMouseClicked
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        ...
        try {
            ...
            obj.sigla=txt_sigla.getText();
        
            int result = new RequestController().postCoin("http://localhost:3000/coin",obj);
            
            if(result==200){
                int res = new  MessageBox().show("Moeda Cadastrada com Sucesso!\n Deseja Cadastrar outra Moeda?");
                if(res==0)
                {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_addCoin().setVisible(true);
            }
        });
    }
