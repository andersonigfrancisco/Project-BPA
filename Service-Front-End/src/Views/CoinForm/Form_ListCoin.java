...
import Controllers.Coin.TableModels;
...
public class Form_ListCoin extends javax.swing.JFrame {
    
    private final TableModels tableModels;
    
    public Form_ListCoin() throws Exception {
        initComponents();
        
        this.tableModels = new TableModels();
        this.tableModels.getdata(new RequestController().getCoin("http://localhost:3000/coin"));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista de Moedas Disponiveis");
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        try {
            ...
            int result = new RequestController().deleteCoin("http://localhost:3000/coin/"+id);
            if(result==200){
                this.tableModels.fireTableDataChanged();
                int res = new  MessageBox().show("Moeda Eliminada com Sucesso!\n Deseja Cadastrar outra Moeda?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new Form_ListCoin().setVisible(true);
            } catch (Exception ex) {
                Logger.getLogger(Form_ListCoin.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
