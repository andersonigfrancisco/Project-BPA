...
public class Form_login extends javax.swing.JFrame {
    ...
    ImageIcon icon = new ImageIcon("src/main/java/imgs/logo.png");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
       ...
       ImageIcon img = new ImageIcon("src/main/java/imgs/left.jpg");
       img.setImage(img.getImage().getScaledInstance(pn_right.getWidth(), pn_right.getHeight(), 1));
       pn_right.setIcon(img);
       
       ImageIcon iconlog = new ImageIcon("src/main/java/imgs/logo.png");
